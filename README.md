...
* **Object-Oriented Programming:** Implemented classes and objects to represent the boat, the villages, and the river nodes.
* **Modular Design:** Structured the code cleanly separating headers (`.h`) and implementations (`.cpp`) to ensure maintainability.
* **Custom Data Structures:** Built and managed a Binary Tree from scratch to map the river's topology.
* **Algorithmic Thinking:** Applied recursive traversal algorithms to calculate the most efficient navigation routes.

##Tech Stack
* **Language:** C++
* **Concepts:** OOP, Pointers, Memory Allocation, Binary Trees, Recursion.
